import { AlertTitle, Button, Grid, TextField, Typography } from '@mui/material'
...
useEffect(()=>{
  ...
  .then((res)=>{
    if(res.data.message=="Blog Updated succsessfully"){
    ...
    <div style={{margin:'6%'}}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={12} md={12}>
          <TextField variant='outlined' label='Post title' fullWidth onChange={inputHandler} value={post.title} name='title'></TextField>
        </Grid>
        <Grid item xs={12} sm={12} md={12}>
          <TextField variant='outlined' label='Type a post'fullWidth multiline rows={6} name='post' onChange={inputHandler} value={post.post}></TextField>
        </Grid>
        <Grid item xs={12} sm={12} md={12}>
          <TextField variant='outlined' label='Image Url' fullWidth name='image' value={post.image} onChange={inputHandler}></TextField>
        </Grid>
        <Grid item xs={12} sm={12} md={12}>
